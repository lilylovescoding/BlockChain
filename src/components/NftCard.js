...
import ContractNfts from "./ContractNfts";
import ContractTrades from "./ContractTrades";
  ...
  return (
    <List.Item key={nft.token_id}>
      <Card
        ...
        extra={
          <Space>
            <ContractNfts tokenAddress={nft.token_address} />
            <ContractTrades tokenAddress={nft.token_address} />
          </Space>
        }
      >
        <Image
